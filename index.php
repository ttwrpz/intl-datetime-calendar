...
class Intl_DateTime_Calendar {
    ...
    public function register_settings() {
        register_setting( 'intl_datetime_calendar', 'intl_datetime_calendar_settings' );
    ...
    public function settings_section_callback() {
        echo '<p>' . __( 'Choose which calendar system to use for displaying dates.', 'intl-datetime-calendar' ) . '</p>';
    }
    ...
    public function calendar_type_callback() {
        ...
        <select name="intl_datetime_calendar_settings[calendar_type]" id="calendar_type">
            <option value="gregory" <?php selected( $options['calendar_type'], 'gregory' ); ?>><?php _e( 'Gregorian (Western)', 'intl-datetime-calendar' ); ?></option>
            <option value="buddhist" <?php selected( $options['calendar_type'], 'buddhist' ); ?>><?php _e( 'Buddhist', 'intl-datetime-calendar' ); ?></option>
            <option value="chinese" <?php selected( $options['calendar_type'], 'chinese' ); ?>><?php _e( 'Chinese', 'intl-datetime-calendar' ); ?></option>
            <option value="coptic" <?php selected( $options['calendar_type'], 'coptic' ); ?>><?php _e( 'Coptic', 'intl-datetime-calendar' ); ?></option>
            <option value="ethiopic" <?php selected( $options['calendar_type'], 'ethiopic' ); ?>><?php _e( 'Ethiopic', 'intl-datetime-calendar' ); ?></option>
            <option value="hebrew" <?php selected( $options['calendar_type'], 'hebrew' ); ?>><?php _e( 'Hebrew', 'intl-datetime-calendar' ); ?></option>
            <option value="indian" <?php selected( $options['calendar_type'], 'indian' ); ?>><?php _e( 'Indian', 'intl-datetime-calendar' ); ?></option>
            <option value="islamic" <?php selected( $options['calendar_type'], 'islamic' ); ?>><?php _e( 'Islamic', 'intl-datetime-calendar' ); ?></option>
            <option value="iso8601" <?php selected( $options['calendar_type'], 'iso8601' ); ?>><?php _e( 'ISO 8601', 'intl-datetime-calendar' ); ?></option>
            <option value="japanese" <?php selected( $options['calendar_type'], 'japanese' ); ?>><?php _e( 'Japanese', 'intl-datetime-calendar' ); ?></option>
            <option value="persian" <?php selected( $options['calendar_type'], 'persian' ); ?>><?php _e( 'Persian', 'intl-datetime-calendar' ); ?></option>
            <option value="roc" <?php selected( $options['calendar_type'], 'roc' ); ?>><?php _e( 'Republic of China', 'intl-datetime-calendar' ); ?></option>
        </select>
        <p class="description"><?php _e( 'Select which calendar system to use for displaying dates.', 'intl-datetime-calendar' ); ?></p>
        <?php
    }
